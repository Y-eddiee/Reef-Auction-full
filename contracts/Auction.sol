...
contract Auction {
	...
	// Constructor
	constructor() public {	
		addItem("Heart Shaped Island", "Heart Reef, part of the Great Barrier Reef of the Whitesundays", 20, 2, 20);
		addItem("Agincourt Reef", "Agincourt reef has long been one of the most popular diving locations in the entire Great Barrier Reef", 200, 20, 200);
		addItem("Flynn Reef", "Wonderful example of Outer Reef beauty; diving opportunities for beginner and advanced alike; excellent mix of marine life; high level of visibility", 150, 35, 150);
		addItem("Green Island", "Easily accessibly “taste of the reef”; great mix of facilities and activities; snorkelling just off shore; luxurious accommodation", 1000, 100, 1000);
	}
