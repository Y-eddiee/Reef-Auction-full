App = {
  ...
  // Initialization function with loads all the art and information from the reef.json file
  // You need to make sure reef.json matches the smart contract initial variables
  ...
  init: async function() {
    // Load art.
    $.getJSON('../reef.json', function(data) {
      var artRow = $('#artRow');
